...
enum SettingsPage: Hashable {
    ...
    case mouse, switcher, keyDebounce, superKey, rightOptionDelete, cutPaste, autoQuit, cleaner, uninstaller, urlCleaner, homebrew, appUpdates, media, clipboard, windowLayout, shelf, quickTools, textSnippets, screenshot, radialMenu, commandBar, killProcess
...
extension AppFeature {
    ...
    var settingsDestination: FeatureSettingsDestination {
        ...
        case .rightOptionDelete: return FeatureSettingsDestination(.rightOptionDelete)
...
enum FeatureVisibilitySupport {
    ...
    static func features(for page: SettingsPage) -> [AppFeature] {
        ...
        case .rightOptionDelete: return [.rightOptionDelete]
