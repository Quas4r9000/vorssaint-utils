    ...
    static func sections(_ s: Strings,
        ...
        return [
            ...
            (categories.utilities, [
                ...
                SettingsDirectoryItem(page: .rightOptionDelete,
                                      title: FeatureStrings.rightOptionDelete(language).pageTitle,
                                      icon: "delete.right",
                                      keywords: [FeatureStrings.rightOptionDelete(language).enableToggle]),
