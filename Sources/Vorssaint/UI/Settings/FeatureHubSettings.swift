...
extension AppFeature {
    ...
    func hubTitle(_ s: Strings, hub: FeatureHubStrings) -> String {
        ...
        case .rightOptionDelete: return FeatureStrings.rightOptionDelete(L10n.shared.language).pageTitle
    ...
    func hubDescription(_ hub: FeatureHubStrings) -> String {
        ...
        case .rightOptionDelete: return FeatureStrings.rightOptionDelete(L10n.shared.language).hubDescription
